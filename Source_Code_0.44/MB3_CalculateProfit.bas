...
Private Function fProcessData()
    ...
    For lEachRow = LBound(arrMaster, 1) To UBound(arrMaster, 1)
        ...
        If fIsPromotionProduct(sProductKey) Then
            dblGrossPrice2CZL = dblSellPrice * fGetPromotionProductRebate(sProductKey)
        Else
        ...
        If fIsPromotionProduct(sProductKey) Then
            arrOutput(lEachRow, dictRptColIndex("GrossProfitPerUnit")) = dblSellPrice * fGetPromotionProductRebate(sProductKey)
        Else
