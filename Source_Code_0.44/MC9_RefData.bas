...
End Function
Function fGetPromotionProductRebate(sProductKey As String) As Double
    If dictPromotionProducts Is Nothing Then fReadSheetPromotionProducts2Dictionary
    
    If dictPromotionProducts.Exists(sProductKey) Then
        If IsNumeric(dictPromotionProducts(sProductKey)) Then
            fGetPromotionProductRebate = dictPromotionProducts(sProductKey)
        Else
...
Function fReadSheetProductTaxRate2Dictionary()
    ...
    Call shtProdTaxRate.fValidateSheet(False)
